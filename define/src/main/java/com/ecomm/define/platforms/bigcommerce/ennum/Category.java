...
public enum Category {
    ...
    TV_TABLE(33, "TV Table"),
    MEDIA_TABLE(33, "Media Table"),
    TV_CABINET(33, "TV Cabinet"),
    MEDIA_CABINET(33, "Media Cabinet"),
    ...
    KD_STORAGE(45, "Display Cabinet"),
    STORAGE_BUFFET(81, "Buffet"),
    STORAGE_SIDEBOARD(80, "Sideboard"),
    BEDROOM_BATHROOM(46, "Bedroom"),
    DRESSING_TABLE(46, "Dressing Table"),
    BB_BEDS(47, "Bed"),
    ...
    HF_PLAQUE_HOLDER(59, "Plaque Holder"),
    HF_DISPLAY_BRACKET(59, "Display Bracket"),
    ...
    HALLWAY(68, "Hallway"),
    INTERIOR(69, "Furniture (All)"),
    HALLWAY_CONSOLE_TABLES(70, "Console Table"),
    ...
    ART_STAND(92,"Stand"),
    CANNISTER(93,"Cannister"),
    DISH(94,"Dish"),
    TRAY(94,"Tray"),
    SIDE_TABLE(96,"Side Table"),
    SIDETABLE(96,"Sidetable"),
