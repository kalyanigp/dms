...
public class BigCommerceCsvProduct {
    ...
    @CsvBindByName(column = "Product Image ID - 8")
    private String productImageID_8;
    @CsvBindByName(column = "Product Image File - 8")
    private String productImageFile_8;
    @CsvBindByName(column = "Product Image Description - 8")
    private String productImageDescription_8;
    @CsvBindByName(column = "Product Image Is Thumbnail - 8")
    private String productImageIsThumbnail_8;
    @CsvBindByName(column = "Product Image Sort - 8")
    private String productImageSort_8;

    @CsvBindByName(column = "Product Image ID - 9")
    private String productImageID_9;
    @CsvBindByName(column = "Product Image File - 9")
    private String productImageFile_9;
    @CsvBindByName(column = "Product Image Description - 9")
    private String productImageDescription_9;
    @CsvBindByName(column = "Product Image Is Thumbnail - 9")
    private String productImageIsThumbnail_9;
    @CsvBindByName(column = "Product Image Sort - 9")
    private String productImageSort_9;
